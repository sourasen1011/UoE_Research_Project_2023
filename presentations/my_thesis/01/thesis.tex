...
Explainability of results is sought through SHAP values \cite{shap_force_plot} \cite{shap}. Figure \ref{fig:shap} shows the breakdown for one patient over a particular discrete time period.
