...
\begin{table*}[t]
  ...
  \begin{tabular}{|p{4cm}|p{10cm}|p{1.5cm}|p{1.5cm}|}
    ...
    \hline
    Cox Proportional Hazards & penalizer = 0.1, step\_size = 0.1 & 0.6953 & \textbf{0.1731}\\
    \hline
    Weibull AFT & penalizer = 0.01  & 0.6953 & 0.1741\\
    \hline
