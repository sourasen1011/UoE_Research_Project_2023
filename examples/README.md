This directory contains experiments with some other datasets:
...
The consensus is that tree-based models with default parameters generally outperform all other models. It will likely take a lot of hand-tuning to get TIS or PyCox to perform as well.